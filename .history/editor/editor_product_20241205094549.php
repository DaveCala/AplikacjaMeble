...
document.getElementById('add-variation').addEventListener('submit', function (e) {
  ...
  .then(data => {
    if (data.success) {
      ...
      // Dodanie nowej wariacji do listy bez odświeżania strony
      const variationsList = document.getElementById('variations-list'); // Zakładam, że lista ma id variations-list
      const newVariation = document.createElement('div');
      newVariation.className = 'bg-gray-900 p-4 border border-gray-700 rounded-lg shadow-md flex items-center mb-4';
