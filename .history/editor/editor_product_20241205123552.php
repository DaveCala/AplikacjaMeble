...
<body class="bg-gray-800 text-white">
  ...
  <form id="add-variation" method="POST" enctype="multipart/form-data" action="add_variation.php">
    ...
    <input type="hidden" id="product-id" name="product_id" value="1234"> <!-- Wartość ID produktu -->
    ...
    <div class="mb-4 text-white">
      <label for="variation-image" class="block mb-2 text-sm">Obraz główny:</label>
    ...
    <div class="mb-4 text-white">
      <label for="variation-ean" class="block mb-2 text-sm">Numer EAN:</label>
...
function openVariationForm(productId) {
  const form = document.getElementById('add-variation-form');
  const productIdInput = document.getElementById('product-id');

  productIdInput.value = productId; // Ustaw dynamiczne ID produktu
