...
<!-- Sekcja dodawania wariacji -->
<div class="flex justify-between items-center mt-10 mb-4 mx-6">
  <h2 class="text-2xl text-white">Wariacje produktu:</h2>
  <div class="flex items-center space-x-4">
    <div id="delete-button-container" class="hidden">
      <button id="delete-selected-variations" class="bg-gray-800 text-red-500 border border-red-500 py-2 px-4 rounded-lg hover:bg-red-700 hover:text-white">
        Usuń zaznaczone wariacje
      </button>
    </div>
...
<div id="add-variation-form" class="hidden bg-gray-900 p-6 rounded-lg shadow-lg mb-6">
  ...
  <form id="add-variation" method="POST" enctype="multipart/form-data" action="add_variation.php">
    ...
    <div class="mb-4 text-white">
      <label for="variation-price" class="block mb-2 text-sm">Cena:</label>
      <input type="text" id="variation-price" name="price" class="w-full p-3 rounded-lg bg-gray-700 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500" required>
    </div>
    <div class="mb-4 text-white">
  ...
  document.getElementById('add-variation').addEventListener('submit', function (e) {
    ...
    document.getElementById('toggle-add-variation-form').addEventListener('click', function() {
      ...
      // Jeśli formularz jest ukryty, pokaż go, w przeciwnym razie ukryj
