...
// Przypisanie wartości PHP do zmiennej JavaScript
let isVariation = <?php echo $isVariation; ?>;

if (isVariation === 1) {
    console.log("Produkt jest wariacją");
    // Ukryj formularz dodawania wariacji
    document.getElementById("add-variation-form").style.display = "none";
} else {
    console.log("Produkt nie jest wariacją");
    // Pokaż formularz dodawania wariacji
    document.getElementById("add-variation-form").style.display = "block";
}

// JavaScript do wyświetlania formularza dodawania wariacji tylko wtedy, gdy produkt nie jest wariacją
document.getElementById('toggle-add-variation-form').addEventListener('click', function() {
        var form = document.getElementById('add-variation-form');
