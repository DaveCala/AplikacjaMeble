...
<body class="bg-gray-800 text-white">
  ...
  <h2 class="text-2xl text-white mb-4">Dodaj wariację do produktu</h2>
  <form id="add-variation" method="POST" enctype="multipart/form-data" action="add_variation.php">
    <!-- Ukryte pole dla product_id -->
    ...
    <div class="mb-4 text-white">
      ...
      <input type="text" id="variation-ean" name="ean" class="w-full p-3 rounded-lg bg-gray-700 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500">
    </div>
