...
<div class="container mx-auto p-6">
    ...
    <form id="edit-product-form" enctype="multipart/form-data">
      ...
      <!-- Pole do aktualizacji zdjęcia -->
      <div class="mb-4">
        <label for="edit-product-image" class="block mb-2 text-sm">Aktualne zdjęcie:</label>
        <div class="mb-2">
          <!-- Pokazuje istniejące zdjęcie produktu, jeśli jest dostępne -->
          <?php if (!empty($product['image'])): ?>
            <img src="<?php echo htmlspecialchars($product['image']); ?>" alt="Produkt" class="w-32 h-32 object-cover rounded-lg">
          <?php endif; ?>
        </div>
        <label for="edit-product-image" class="block mb-2 text-sm">Zmień zdjęcie:</label>
