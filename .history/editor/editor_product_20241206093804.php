...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.querySelectorAll('.save-variation').forEach(button => {
    // Usuwamy istniejące zdarzenia, aby uniknąć dublowania
    button.removeEventListener('click', handleSaveVariation);
    button.addEventListener('click', handleSaveVariation);
  });

  // Obsługa otwierania/zamykania szczegółów
  document.querySelectorAll('.toggle-details').forEach(button => {
    // Usuwamy istniejące zdarzenia, aby uniknąć dublowania
...
// Funkcja obsługująca zapisanie zmian dla wariacji
function handleSaveVariation(event) {
  ...
  fetch('update_variation.php', {
    ...
    .then(data => {
      if (data.success) {
        ...
        // Ukrycie szczegółów po zapisaniu
