...
if (isset($_POST['title'], $_POST['ean'], $_POST['price'], $_POST['description'])) {
    // product_id ustawiane automatycznie (np. z sesji, stała wartość lub inna logika)
    $productId = 12345; // Możesz zastąpić to odpowiednią metodą, np. z sesji: $_SESSION['product_id']
