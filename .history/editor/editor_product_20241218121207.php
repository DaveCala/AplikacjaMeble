...
<div class="container mx-auto p-6">
    ...
    <?php if ($product['isVariation'] ?? false): ?>
        ...
        <form id="edit-variation-product-form" enctype="multipart/form-data">
            <input type="hidden" id="product-id" name="product_id" value="<?php echo htmlspecialchars($product['id']); ?>">

            <!-- Tytuł -->
            <div class="mb-4">
                <label for="edit-product-title" class="block mb-2 text-sm">Tytuł:</label>
            ...
            <!-- EAN -->
            <div class="mb-4">
                <label for="edit-product-ean" class="block mb-2 text-sm">EAN:</label>
                <input type="text" id="edit-product-ean" name="ean" 
    ...
    <?php else: ?>
        <!-- Panel z listą wariacji, gdy isVariation = false -->
