  ...
  <div class="flex items-center space-x-4 mr-6">
    ...
    <div class="relative flex items-center">
      <img src="../img/mailbox.png" alt="Ikona Powiadomień" 
           class="ml-8 w-10 h-10 cursor-pointer hover:scale-110 transition-transform duration-200">
      <span class="absolute top-0 left-10 bg-red-600 text-white text-xs font-bold px-2 py-1 rounded-full">
        3
      </span>
    </div>
  </div>
