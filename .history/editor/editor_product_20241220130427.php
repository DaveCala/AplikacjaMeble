...
<!-- Przycisk dodawania nowej wariacji, tylko jeśli produkt nie jest wariacją -->
<?php if (!isset($product['is_variation']) || $product['is_variation'] == 0) : ?>
  ...
  <h2 class="text-2xl text-white">Lista wariacji:</h2>
    ...
    <form id="edit-variation-form-<?php echo $variation['id']; ?>" data-variation-id="<?php echo $variation['id']; ?>">
        ...
        <input type="text" id="title-<?php echo $variation['id']; ?>" name="title"
               ...
               class="w-full p-2 bg-gray-600 text-white rounded-lg">
        ...
        <div class="mt-4">
          <button type="submit" class="py-2 px-4 bg-blue-600 text-white rounded-lg hover:bg-blue-500">
            Zapisz zmiany
          </button>
        </div>
      </form>
...
<?php else : ?>
<p class="text-gray-400">Brak wariacji.</p>
<?php endif; ?>
