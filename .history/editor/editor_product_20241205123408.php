...
<body class="bg-gray-800 text-white">
  ...
  <form id="add-variation" method="POST" enctype="multipart/form-data" action="add_variation.php">
    ...
    <div class="mb-4 text-white">
      <label for="variation-price" class="block mb-2 text-sm">Cena wariacji:</label>
      <input type="number" id="variation-price" name="price" class="w-full p-3 rounded-lg bg-gray-700 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500" required>
    </div>
