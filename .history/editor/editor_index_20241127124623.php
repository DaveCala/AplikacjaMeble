  ...
  <div class="bg-gray-900 w-full p-4 border border-gray-700">
    <div class="grid grid-cols-5 gap-4 w-full h-12 items-center rounded-lg p-2 overflow-hidden">
      ...
      <?php foreach ($products as $product): ?>
        <div class="col-span-5 md:col-span-1 flex items-center justify-between text-white p-4 rounded-lg bg-gray-800 mb-4">
          ...
          <div class="col-span-1 flex items-center justify-center">
            <img src="<?php echo htmlspecialchars($product['image']); ?>" alt="Główne zdjęcie" class="h-full max-h-8 w-auto object-contain rounded-lg">
          </div>
